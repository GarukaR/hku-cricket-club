// PROTOTYPE — throwaway. Floating variant switcher for the team-list
// hierarchy question, gated out of production builds.
"use client";
...
export function PrototypeSwitcher() {
  ...
  return (
    ...
    >
      ...
      <span style={{ whiteSpace: "nowrap", minWidth: "10rem", textAlign: "center" }}>
