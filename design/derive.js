...
// ── crest anchors (eyeballed from the supplied screenshot — PROVISIONAL) ──
const CREST = {
  red:     '#E63329',
  gold:    '#EFC31F',
  green:   '#0F8A6A',
...
// Run: node design/derive.js --css > /tmp/tokens.css
if (QUIET && !fails) {
  ...
  console.log(`/* GENERATED by design/derive.js — do not hand-edit.
   Regenerate after updating the CREST anchors:  node design/derive.js --css
