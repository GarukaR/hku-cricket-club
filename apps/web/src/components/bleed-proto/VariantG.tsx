...
import styles from "./VariantG.module.css";

const marks = { Instagram, Facebook, YouTube } as const;

/** G — the whole footer bleeds. The plate runs to all four edges and the
 *  imprint is on the ink with everything else, so the sheet ends in ink rather
 *  than in a strip of paper under a block of it. */
export function FootG() {
  return (
